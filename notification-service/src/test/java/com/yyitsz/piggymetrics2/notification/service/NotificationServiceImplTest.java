...
import com.yyitsz.piggymetrics2.notification.client.AccountServiceClient;
...
public class NotificationServiceImplTest {
    ...
    public void shouldSendRemindNotificationsEvenWhenErrorsOccursForSomeRecipients() throws IOException, MessagingException, InterruptedException {
        ...
        verify(emailService, timeout(200)).send(NotificationType.REMIND, withNoError, null);
        verify(recipientService, timeout(200)).markNotified(NotificationType.REMIND, withNoError);
